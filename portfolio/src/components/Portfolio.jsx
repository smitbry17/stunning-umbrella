...
{/* Image section */}
        <a className=" flex bg-gray-600 bg-opacity-30 h-3/5 w-3/6 pt-16 mt-56 rounded-lg shadow-xl shadow-black items-center justify-center" href="https://evening-gorge-15067.herokuapp.com/" target="_blank" rel="noopener noreferrer">
        <img
